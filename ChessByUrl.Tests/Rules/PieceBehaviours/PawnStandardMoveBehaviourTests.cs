...
namespace ChessByUrl.Tests.Rules.PieceBehaviours
{
    ...
    public class PawnStandardMoveBehaviourTests
    {
        ...
        public void GetLegalMovesFrom_White_EmptySquareAhead()
        {
            ...
            actualMoves = behaviour.GetLegalMovesFrom(fakes.Ruleset, fakes.Board, "c3", pieceType);
            expectedMoves = [ new Move { From = "c3", To = "c4" } ];
            CollectionAssert.AreEqual(expectedMoves, actualMoves);

            actualMoves = behaviour.GetLegalMovesFrom(fakes.Ruleset, fakes.Board, "g7", pieceType);
        ...
        public void GetLegalMovesFrom_Black_EmptySquareAhead()
        {
            ...
            var actualMoves = behaviour.GetLegalMovesFrom(fakes.Ruleset, fakes.Board, "b7", pieceType);
            Move[] expectedMoves = [ new Move { From = "b7", To = "b6" } ];
            CollectionAssert.AreEqual(expectedMoves, actualMoves);

            actualMoves = behaviour.GetLegalMovesFrom(fakes.Ruleset, fakes.Board, "c6", pieceType);
            expectedMoves = [ new Move { From = "c6", To = "c5" } ];
            CollectionAssert.AreEqual(expectedMoves, actualMoves);

            actualMoves = behaviour.GetLegalMovesFrom(fakes.Ruleset, fakes.Board, "g2", pieceType);
